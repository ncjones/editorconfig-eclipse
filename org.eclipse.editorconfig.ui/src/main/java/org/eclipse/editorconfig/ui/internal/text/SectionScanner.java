...
/**
 * A rule based section scanner.
 *
 */
public final class SectionScanner extends AbstractEditorConfigScanner {
	...
	private static String[] fgTokenProperties = { PreferenceConstants.EDITOR_CONFIG_COLORING_SECTION,
	 ...
	 */
	public SectionScanner(IColorManager manager, IPreferenceStore store) {
		super(manager, store);
		initialize();
	}
