 ...
 *     Angelo Zerr <angelo.zerr@gmail.com> - copied from org.eclipse.jdt.internal.ui.text.AbstractJavaScanner
 ...
 * </p>
 */
public abstract class AbstractEditorConfigScanner extends BufferedRuleBasedScanner {
	 ...
	 */
	public AbstractEditorConfigScanner(IColorManager manager, IPreferenceStore store) {
		super();
	...
	private void adaptToColorChange(Token token, PropertyChangeEvent event) {
		...
		if (rgb != null) {
			...
			if ((color == null || !rgb.equals(color.getRGB()))) {
				IColorManager ext = fColorManager;
